				...
				<div class="postbox" style="float:left;">
					<div class="inside">
						...
						<div style="float:left;width:60%;padding:2%;">
							...
							Myself, a Software Professional by work. I started my career into Software Development Industry in 2009 with PHP as my base technology. It was then I started playing with WordPress plugins for a project at my firm. Soon I thought of making my own plugins for WordPress and I finally ended up here.
							</div>
							<br />
							<div style="text-align: justify">
							...
							<br />
							I'm no expert in coding. Apologies for the bugs in this plugin <img width="20" height="20" src="<?php echo trailingslashit( WP_PLUGIN_URL . '/' .	dirname(dirname( plugin_basename(__FILE__)))) ?>/images/2.png" /> Do let me know your suggestions and issues through WordPress Plugin Support Forum.
							<br/>
							<br />
