...
<div style="display: none;">
		<div id="skin_help" style="width:650px;height:230px;overflow:auto;font-size:13px;">
			...
			<ul>
				...
				<!-- <ol>
					3. Copy the original zip file inside the extracted folder.
				</ol> -->
				<ol>
			...
			<i style="font-size:12px;">Note by Author: In upcoming version upgrades for CVG, skin upload feature through admin panel will be enabled :)</i>
		</div>
</div>